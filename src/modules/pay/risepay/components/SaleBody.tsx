    ...
    if(memberTypeId == '3') {
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l2_part1_0803_1.jpeg'
            }),
            // {
            //   dom: <CustomerEvaluate/>
            // },
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l2_part2_0803_1.jpeg'
            }), {
      ...
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l1_part1_0803_1.jpeg'
            }),
            // {
            //   dom: <CustomerEvaluate/>
            // },
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l1_part2_0803_1.jpeg'
            }), {
              dom: <div className="protocol-container l1">
                <span className="click_text">点击查看</span>
                <a className="protocol" onClick={() => this.clickUserProtocol()}>【商学院用户协议】</a>
