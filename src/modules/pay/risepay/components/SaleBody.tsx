    ...
    if(memberTypeId == '3') {
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l2_part2_0810_1.jpg'
            }),
            // {
            //   dom: <CustomerEvaluate/>
            // },
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l2_part1_0810_1.jpg'
            }), {
      ...
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_l1_part1_0812_1.jpeg'
            }),
            // {
            //   dom: <CustomerEvaluate/>
            // },
