  ...
  render() {
    ...
    return (
      <div className="business-school-intro-pic-container"
        ...
        <img
          className="pic-part1"
          src="https://static.iqycamp.com/images/fragment/pay_rise_part1_13.png?imageslim"
          style={{ width: '100%' }}
          onLoad={() => this.setState({ loading: false })}/>
        {
          !loading && <CustomerEvaluate/>
        }
        <img className="pic-part2" src="https://static.iqycamp.com/images/fragment/pay_rise_part2_12.png?imageslim"
             style={{ width: '100%' }}/>
