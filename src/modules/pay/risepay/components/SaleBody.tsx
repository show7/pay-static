    ...
    if(memberTypeId == '3') {
      ...
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/thought_sale_page_1_0831_1.jpeg'
            }),
            // {
            ...
            mergeStyle({
              url: 'https://static.iqycamp.com/images/thought_sale_page_2_0831_3.jpg'
            }),
            mergeStyle({
              url: 'https://static.iqycamp.com/images/thought_sale_page_3_0901_1.jpeg'
            }), {
