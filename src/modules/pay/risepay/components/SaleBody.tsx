    ...
    if(memberTypeId == '3') {
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/pay_rise_part1_17.jpg?imageslim'
            }),
            mergeStyle({
      ...
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/images/fragment/thought_sale_page_1_0530_1.jpg?imageslim'
            }), {
