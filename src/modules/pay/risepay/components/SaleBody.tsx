    ...
    if(memberTypeId == '3') {
      ...
      return (
        <div className="business-school-intro-pic-container"
          ...
          <SequenceDisplay imgList={[
            mergeStyle({
              url: 'https://static.iqycamp.com/WechatIMG421-t0t8fzqc.jpeg'
            }),
            // {
            ...
            mergeStyle({
              url: 'https://static.iqycamp.com/WechatIMG422-5dzsgeym.jpeg'
            }),
            mergeStyle({
              url: 'https://static.iqycamp.com/WechatIMG423-perz804f.jpeg'
            }), {
