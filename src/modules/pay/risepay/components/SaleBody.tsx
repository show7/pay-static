  ...
  render() {
          ...
          <div className="user-protocol">
            <div className="relative-position">
              ...
              <div className="content">
                ...
                <p>1、为了保证你的学习效果，在圈外同学学习期间，同时最多可以开启3门课程的学习;圈外推荐的学习进度为每天0.5~1节，不要超过2节，因此课程最短学习天数为小节数/2，少于最短学习天数，课程无法关闭。 </p>
    ...
    return (
      <div className="business-school-intro-pic-container"
        ...
        <img className="pic-part2" src="https://static.iqycamp.com/images/pay_rise_part2_11.png?imageslim"
             style={{ width: '100%' }}/>
