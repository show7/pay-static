  ...
  render() {
    ...
    return (
      <div className="business-school-intro-pic-container"
           id="business-school-intro-pic-container" style={{ position: `${showModel ? 'fixed' : 'static'}` }}>
        <img
          className="pic-part1"
        ...
        <img className="pic-part2" src="https://static.iqycamp.com/images/pay_rise_part2_5.png?imageslim"
             style={{ width: '100%' }}/>
        <img className="pic-part3" src="https://static.iqycamp.com/images/pay_rise_part3_1.png?imageslim"
             style={{ width: '100%' }}/>
        <div className="protocol-container"  style={{ marginTop: `${(window.innerWidth > 350) ? '-250' : '-200'}px` }}>
