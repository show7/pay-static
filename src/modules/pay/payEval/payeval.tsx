        ...
        <div>
          ...
          <div className="self-init-container">
            ...
            <div className="self-init-context">
              ...
              圈外同学联合<span className='high-line-text'>华东师范大学教育教练研究组</span>，共同开发职业发展潜能测评，通过四大模块、12项专业指标的全面评估，展现你的职业发展潜能，帮你给自己<span
              className='high-line-text'>制定清晰合理的个人发展计划</span>。
            </div>
            <h4 className="self-init-block-title">
                    <span className="block-title-text">
