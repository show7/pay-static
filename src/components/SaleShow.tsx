          ...
          <div className="user-protocol">
            <div className="relative-position">
              ...
              <div className="content">
                ...
                <p>3、圈外同学L2/L3项目学习结束后，获得毕业证的同学可以免费参加一次企业实战项目（没有获得毕业证报名参加需付费），为合作的企业解决真实问题，做到学以致用。</p>
                <p>4、圈外同学用户承诺不得以任何方式利用圈外同学直接或间接从事违反中国法律、以及社会公德的行为，圈外同学有权对违反上述承诺的内容予以删除。</p>
                <p>5、圈外同学用户不得利用圈外同学服务制作、上载、复制、发布、传播或者转载如下内容：</p>
                <p>· 反对宪法所确定的基本原则的；</p>
            ...
            <div className="user-submitbutton-component">
              <div className="user-submit-btn"
                   onClick={() => this.disableUserProtocol()}>确认
              </div>
            </div>
          </div>
        </div>
