        ...
        msg: {
          ...
          city: {
            ...
            贵州省: [
              ...
              {id: 605, name: '铜仁地区'},
              {id: 606, name: '黔西南布依族苗族自治州'},
              {
                id: 607,
                name: '毕节地区',
              },
              {id: 608, name: '黔东南苗族侗族自治州'},
              {id: 609, name: '黔南布依族苗族自治州'},
            ],
            西藏省: [
              {id: 801, name: '拉萨市'},
              {id: 802, name: '昌都地区'},
            ...
            湖北省: [
              ...
              {id: 1012, name: '随州市'},
              {id: 1013, name: '恩施土家族苗族自治州'},
              {id: 1014, name: '省直辖行政单位'},
            ],
            湖南省: [
              {id: 1101, name: '长沙市'},
              {id: 1102, name: '株洲市'},
            ...
            新疆省: [
              ...
              {id: 1804, name: '哈密地区'},
              {id: 1805, name: '昌吉回族自治州'},
              {
                id: 1806,
                name: '博尔塔拉蒙古自治州',
              },
              {id: 1807, name: '巴音郭楞蒙古自治州'},
              {id: 1808, name: '阿克苏地区'},
              {
                id: 1809,
                name: '克孜勒苏柯尔克孜自治州',
            ...
            云南省: [
              ...
              {id: 709, name: '楚雄彝族自治州'},
              {id: 710, name: '红河哈尼族彝族自治州'},
              {
                id: 711,
                name: '文山壮族苗族自治州',
              },
              {id: 712, name: '西双版纳傣族自治州'},
              {id: 713, name: '大理白族自治州'},
              {
                id: 714,
                name: '德宏傣族景颇族自治州',
              },
              {id: 715, name: '怒江傈僳族自治州'},
              {id: 716, name: '迪庆藏族自治州'},
            ],
            北京市: [{id: 101, name: '北京市'}],
            甘肃省: [
              ...
              {id: 1512, name: '陇南市'},
              {id: 1513, name: '临夏回族自治州'},
              {id: 1514, name: '甘南藏族自治州'},
            ],
            宁夏省: [
              {id: 1701, name: '银川市'},
              {id: 1702, name: '石嘴山市'},
            ...
            青海省: [
              ...
              {id: 1604, name: '黄南藏族自治州'},
              {id: 1605, name: '海南藏族自治州'},
              {
                id: 1606,
                name: '果洛藏族自治州',
              },
              {id: 1607, name: '玉树藏族自治州'},
              {id: 1608, name: '海西蒙古族藏族自治州'},
            ],
            天津市: [{id: 301, name: '天津市'}],
            辽宁省: [
              {id: 2801, name: '沈阳市'},
...
router.post ('/signup/payment/coupon/calculate', (req, res) => {
  setTimeout (
    () => res.status (200).json ({msg: 2381.01, code: 200}),
    Math.random () * 1500
  );
});
